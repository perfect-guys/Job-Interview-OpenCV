...
int main(int argc, char** argv)
{
    ...
    face_cascade.load("/usr/local/Cellar/opencv/3.4.1_2/share/OpenCV/haarcascades/haarcascade_frontalface_alt2.xml");
    eye_cascade.load("/usr/local/Cellar/opencv/3.4.1_2/share/OpenCV/haarcascades/haarcascade_eye.xml");
